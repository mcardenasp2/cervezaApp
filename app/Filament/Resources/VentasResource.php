...
class VentasResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            // 'buscar-transacciones' => Pages\BuscarTransacciones::route('/buscar-transacciones'),
            // 'buscar-transacciones' => Pages\BuscarTransacciones::route('/buscar-transacciones'), // ✅ CORRECTO
            // 'buscar-transacciones' => Pages\BuscarTransacciones::class, // ✅ CORRECTO
            // 'buscar-transacciones' => Pages\BuscarTransacciones::route('/buscar-transacciones'),
